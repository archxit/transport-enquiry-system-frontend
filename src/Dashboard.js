...
const Dashboard = () => {
  ...
  // Define fetchRouteDetails before using it in useEffect
  ...
  }, [sourceLocation, destinationLocation, mapRef]);
  ...
  }, [selectedRoute, sourceLocation, destinationLocation, fetchRouteDetails]);
